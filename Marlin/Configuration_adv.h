...
// Заменить на 5 градусов и попробовать негреть стол для 120гр.
#if ENABLED(THERMAL_PROTECTION_BED)
  #define THERMAL_PROTECTION_BED_PERIOD        60 // 20 // Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS    10 //  2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                90 // 60 // Seconds
...
/*** 
  Если MINIMUM_STEPPER_PULSE = 1 (по умолчанию), Babystepping повесит "Дельту".
  Надо в 'stepper.cpp' заменить 
  ...
  Или раскоментировать #define MINIMUM_STEPPER_PULSE 2, находящийся выше.
***/
