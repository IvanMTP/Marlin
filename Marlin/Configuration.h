 ...
 * 1 ... Z Probe Offset of -19.0mm
 * 2 ... Z Probe Offset of -16.8mm
 * 3 ... Infrared Probe
 * 4 ... 3D_Touch (Китайский клон BL_Touch)
 */
...
#define STRING_CONFIG_H_AUTHOR "(MoToP, IR Probe, HotBed_PID, Linear Advance, v2.35)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anycubic Kossel - run 'M106 S255' & 'M303 E0 C10 S200'
    ...
    #define DEFAULT_Kp_LIST {  21.37,  21.37 }
    #define DEFAULT_Ki_LIST {   1.37,   1.37 }
    #define DEFAULT_Kd_LIST {  83.58,  83.58 }
  #else
    #define DEFAULT_Kp  21.37
    #define DEFAULT_Ki   1.37
    #define DEFAULT_Kd  83.58
  #endif
#endif // PIDTEMP
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 116.0  // 120.0  // (mm)
    // Maximum reachable area
    #define DELTA_MAX_RADIUS       116.0  // 120.0  // (mm)
    // Center-to-center distance of the holes in the diagonal push rods.
    #define DELTA_DIAGONAL_ROD 267.0       // (mm)
      // Horizontal offset from middle of printer to smooth rod center.
    #define DELTA_SMOOTH_ROD_OFFSET 184.28 // (mm)
    // Horizontal offset of the universal joints on the end effector.
    #define DELTA_EFFECTOR_OFFSET 31.0     // (mm)
    // Horizontal offset of the universal joints on the carriages.
    #define DELTA_CARRIAGE_OFFSET 21.1    // (mm)
  ...
  #define DELTA_HEIGHT 289.70             // (mm) Get this value from G33 auto calibrate
  ...
  //#define DELTA_DIAGONAL_ROD_TRIM_TOWER { -0.20, 0.70, 0.20 }
 ...
 */
//#if ANYCUBIC_PROBE_VERSION > 0
#if (ANYCUBIC_PROBE_VERSION == 1) || (ANYCUBIC_PROBE_VERSION == 2) || (ANYCUBIC_PROBE_VERSION == 3)
 ...
 */
#if ANYCUBIC_PROBE_VERSION == 4
  #define NOZZLE_TO_PROBE_OFFSET { 31.5, 17, -0.85 }
#elif ANYCUBIC_PROBE_VERSION == 3
  #define NOZZLE_TO_PROBE_OFFSET { 25.70, -1.90, -1.15 }
...
#if (ANYCUBIC_PROBE_VERSION == 1) || (ANYCUBIC_PROBE_VERSION == 2)
